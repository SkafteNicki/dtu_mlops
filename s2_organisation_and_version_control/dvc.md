...
10. Lets now look at the process of creating a new version of our data. We are going to add some new data to our dataset
    ...
    files in your `processed` folder. The new data should contain 3 extra datafiles with a total of 15000 additional
    observations.
