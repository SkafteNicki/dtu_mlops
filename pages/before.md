...
[here](https://github.com/SkafteNicki/dtu_mlops/archive/refs/heads/main.zip) and unzip it inside the folder you created 
above (for now). We will touch on git during day 2 of the course.
...
which we use for communication. All course announchements will we shared in the `#general` channel and we have 
